...
<form class="form-signin" method="post" action="login_action">
    ...
    <input type="password" id="inputPassword" style="margin-bottom: 10px;" name="password" class="form-control" placeholder="Password" required>
    <button class="btn btn-lg btn-primary btn-block" type="submit">Sign in</button>
    <br><br>
    <a class="btn btn btn-secondary tn-block" href="register">Sign up</a>
